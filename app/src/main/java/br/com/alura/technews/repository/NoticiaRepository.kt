...
class NoticiaRepository(
    ...
    fun buscaTodos(): LiveData<Resource<List<Noticia>?>> {
        val atualizarNoticias: (List<Noticia>) -> Unit = {
            noticiasEncontradas.value = Resource(it)
        }
        buscaInterno(quandoSucesso = atualizarNoticias)
        buscaNaApi(quandoSucesso = atualizarNoticias,
            quandoFalha = { erro ->
